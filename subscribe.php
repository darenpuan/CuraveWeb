                ...
                <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html"><img src="assets/img/logo-min.png" alt="Curave"></a>
                        </div>
                        <div class="collapse navbar-collapse navbar-right" id="">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a type="button" data-toggle="modal" data-target="#myModal" class="btn button_register">REGISTER</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="col-sm-6 overwatchLogo">
                        <img src="/assets/img/rsz_logo_cs_go.png" alt=" ">
                        <p>COMING SOON</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="hidden-sm hidden-xs">
                            <form action="subscribe.php" method="post" class="form-inline">
                                <div class="input-group">
                                    ...
                                    <input type="email" placeholder="Email Address" class="form-control res" name="email" id="email" required="required" value="<?php echo htmlspecialchars($_POST['email']); ?>">
                        ...
                        <center class="hidden-lg hidden-md">
                            <form action="subscribe.php" method="post" class="form-inline">
                                <div class="input-group">
                                    <p>Get the latest scoop! Sign up for our newsletter today!</p>
                                    <label for="email" class="sr-only">Email</label>
                                    <input type="email" placeholder="Email Address" class="form-control" name="email" id="email" required="required" value="<?php echo htmlspecialchars($_POST['email']); ?>">
                                    <?php echo "<p class='text-danger'>$errEmail</p>";?>
                                    <span class="input-group">
                            <button name="submit" type="submit" value="Submit"><i class="fa fa-send"></i></button>
                            </span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-envelope"></i> Be the first to know when we launch.</h4>
                    </div>
                    <div class="modal-body">
                        <p>Simply enter your email!</p>
                        <form role="form" action="subscribe.php" method="post" class="form-inline" style="text-align: center;">
                            <div class="input-group">
                                <label for="subscribe-email" class="sr-only">Email</label>
                                <input type="email" placeholder="Email Address" class="form-control" name="email" id="subscribe-mail" required="required" value="<?php echo htmlspecialchars($_POST['email']); ?>">
                                <?php echo "<p class='text-danger'>$errEmail</p>";?>
                            </div>
                            <button name="submit" type="submit" value="Submit" class="button_subscribe">Subscribe</button>
                        </form>
                        <p class="padding"><small>By providing your email you consent to receiving (very) occasional promotion emails &amp; newsletters.</small></p>
                    </div>
                </div>
            </div>
        </div>
